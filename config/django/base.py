...
LOCAL_APPS = [
    'wiki_persian.core.apps.CoreConfig',
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='psql://user:password@127.0.0.1:5432/wiki_persian'),
}
...
REST_FRAMEWORK = {
    ...
    'EXCEPTION_HANDLER': 'wiki_persian.api.exception_handlers.drf_default_with_modifications_exception_handler',
    # 'EXCEPTION_HANDLER': 'wiki_persian.api.exception_handlers.hacksoft_proposed_exception_handler',
